...
_SCA_MAP: dict[str, str] = {
    ...
    "ʊ": "U", "ʉ": "U", "ɯ": "U",
    "y": "U", "ø": "E", "œ": "E",
    # Precomposed nasalized vowels (Lycian, Lydian, Avestan)
    "ã": "A", "ẽ": "E", "ĩ": "I", "õ": "O", "ũ": "U",
...
_SEGMENT_RE = re.compile(
    r"[a-zA-Zɑæɐɛəɘɪɨɔɵʊʉɯøœɸβʈɖɡɢʔɦɲŋɳɴɫɭɬɮɾɽʀɹʁɕʑʃʒθðɣχʝʋɰɟʂɻɓɗʕħɺɥɧʙⱱʘǀǁǃǂãẽĩõũ$H<@*]"
    r"(?:\u0361[a-zA-Zɑæɐɛəɘɪɨɔɵʊʉɯøœɸβʈɖɡɢʔɦɲŋɳɴɫɭɬɮɾɽʀɹʁɕʑʃʒθðɣχʝʋɰɟʂɻɓɗʕħɺɥɧʙⱱʘǀǁǃǂãẽĩõũ])?"
    r"[\u0300-\u036F\u0325\u0329\u032A\u033A\u033B\u033C\u02B0\u02B1\u02B7\u02BC\u02D0\u02D1]*"
)
