...
ANCIENT_LANG_INFO: dict[str, tuple[str, str]] = {
    ...
    # Phase 6-7 additions
    "cop": ("afroasiatic_egyptian", "copt1239"),
    "pli": ("indo_aryan", "pali1273"),
    "xcl": ("armenian", "clas1249"),
    "ang": ("germanic", "olde1238"),
    "gez": ("afroasiatic_semitic", "geez1241"),
    "hbo": ("afroasiatic_semitic", "anci1244"),
    "xht": ("isolates", "hatt1246"),
    "osc": ("italic", "osca1245"),
    "xum": ("italic", "umbr1253"),
    "xve": ("italic", "vene1257"),
    "sga": ("celtic", "oldi1245"),
    "nci": ("uto_aztecan", "clas1250"),
    "ojp": ("japonic", "oldj1239"),
    "pal": ("indo_iranian", "midd1359"),
    "sog": ("indo_iranian", "sogd1245"),
    "xtg": ("celtic", "gaul1239"),
    "gem-pro": ("germanic", ""),
    "cel-pro": ("celtic", ""),
    "urj-pro": ("uralic", ""),
    "bnt-pro": ("atlantic_congo", ""),
    "sit-pro": ("sino_tibetan", ""),
    # Phase 8 Batch 1
    "sla-pro": ("balto_slavic", ""),
    "trk-pro": ("turkic", ""),
    "itc-pro": ("italic", ""),
    "jpx-pro": ("japonic", ""),
    "ira-pro": ("indo_iranian", ""),
    "xfa": ("italic", "fali1291"),
    "xlp": ("celtic", "lepo1240"),
    "xce": ("celtic", "celt1248"),
    "xsa": ("afroasiatic_semitic", "olda1245"),
    # Phase 8 Batch 2
    "alg-pro": ("algic", ""),
    "sqj-pro": ("albanian", ""),
    "aav-pro": ("austroasiatic", ""),
    "poz-pol-pro": ("austronesian", ""),
    "tai-pro": ("kra_dai", ""),
    "xto-pro": ("tocharian", ""),
    "poz-oce-pro": ("austronesian", ""),
    "xgn-pro": ("mongolic", ""),
    "xmr": ("nilo_saharan", "mero1241"),
    "obm": ("afroasiatic_semitic", "moab1234"),
    # Phase 8 Batch 3
    "myn-pro": ("mayan", ""),
    "afa-pro": ("afroasiatic", ""),
    "xib": ("isolates", "iber1248"),
    # Phase 8 Eblaite
    "xeb": ("afroasiatic_semitic", "ebla1241"),
}
